...
namespace grapic
{
    ...
    */
    ...
    /** \brief Stop the program until return is pressed
    */
    inline void pause()
    {
        print(10,10,"Press space");
        winDisplay();
        while(!isKeyPressed(SDL_SCANCODE_SPACE)) delay(100);
    }
...
\subsection Windows
  ...
  - Run
     - Open the file grapic.cbp with Codeblocks.
...
\subsection Linux
  ...
  - Command (you can edit the file Makefile if needed):
     - cd grapic
     - make
     - bin/demo
