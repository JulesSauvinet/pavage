        ...
        while (SDL_PollEvent(&events))
        {
            switch (events.type)
            {
                case SDL_QUIT:
                    ...
                    break;
                case SDL_KEYDOWN:
                    //std::cout<<events.key.keysym.scancode<<" "<<m_key.size()<<std::endl;
                    //event.key.keysym.scancode
                    //if (events.key.keysym.scancode == SDL_SCANCODE_LEFT) std::cout<<"inc"<<std::endl;
                    ...
                    break;
 //               case SDL_KEYUP:
 //                   m_key[events.key.keysym.scancode] = false;
 //                   break;
                default:
                    break;
            }
